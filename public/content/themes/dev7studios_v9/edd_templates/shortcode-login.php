	...
	<form id="edd_login_form" class="edd_form" action="" method="post">
		<fieldset>
			...
			<div class="form-group">
				...
				<input name="edd_user_login" id="edd_user_login" class="required edd-input form-control" type="text" title="<?php _e( 'Username', 'edd' ); ?>"/>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input id="edd_login_submit" type="submit" class="edd_submit btn btn-primary" value="<?php _e( 'Log In', 'edd' ); ?>"/>
			</div>
